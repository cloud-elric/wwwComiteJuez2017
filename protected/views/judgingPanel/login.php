<?php 
$this->title = Yii::t('site','titleLogin');
?>
<!-- Page -->
<div class="page animsition vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
	<div class="page-content vertical-align-middle dgom-ui-page-login">
		...
		<div class="form-group">
			...
			<?php echo $form->textField($model,'username', array("class"=>"form-control","required"=>"required", "placeholder"=>Yii::t('login','usuario') )); ?>
			<?php echo $form->error($model,'username'); ?>
		</div>
		<div class="form-group">
			<?php echo $form->labelEx($model,'password', array("class"=>"sr-only")); ?>
			<?php echo $form->passwordField($model,'password', array("class"=>"form-control","required"=>"required", "placeholder"=>Yii::t('login','password') )); ?>
			<?php echo $form->error($model,'password'); ?>
		</div>
		<?php echo CHtml::submitButton(Yii::t('login',  'ingresar'), array("class"=>"btn btn-primary btn-block")); ?>
		<?php
		$this->endWidget ();
		?>
		<!-- 
